...
- Overview：较大的状态面板、本机出口连通性测试、启用状态、sing-box 路径、配置路径、生成、检查、应用、重启。
- Node：当前 AnyTLS 节点摘要、轻量节点列表、手动添加节点、通过 `anytls://` 链接添加节点、弹窗编辑当前节点，以及本机 SOCKS/HTTP 入站。
