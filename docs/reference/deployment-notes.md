...
上游规则可能存在空洞。当前已确认 Twitter/X 的 GeoIP 上游覆盖了 `104.244.40.0/23`、`104.244.42.0/24`、`104.244.44.0/22`，但缺少 `104.244.43.0/24`。Stargate 因此内置 `104.244.43.0/24` 作为代理 GeoIP 补丁，但不在前端暴露为普通配置项。
